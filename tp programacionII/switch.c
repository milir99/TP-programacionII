                ...
                case 4:
                    ...
                    {clearScreen();
                        ...
                        switch(eleccion1)
                        {
                           case 1:
                            clearScreen();
                            ordenarListaPorNombreAuxYMostrar(*listaPracticas,2);
                            system("pause");
                            break;
                        case 2:
                            clearScreen();
                ...
                case 1:
                   ...
                   do
                    {clearScreen();
                        ...
                        case 1:
                            clearScreen();
                            ordenarListaPorNombreAuxYMostrar(*listaPracticas,3);
                            system("pause");
                            break;
                        case 2:
                            clearScreen();
                ...
                case 4:
                    ...
                    {clearScreen();
                        ...
                        switch(eleccion4)
                        {
                         case 1:
                            clearScreen();
                            ordenarListaPorNombreAuxYMostrar(*listaPracticas,tipoPerfil);
                            system("pause");
                            break;
                        case 2:
                            clearScreen();
